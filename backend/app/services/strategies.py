...
from .indicators import calculate_boll, calculate_kdj, detect_boll_break, detect_kdj_cross, detect_ma_cross, moving_average
...
class TechnicalStrategyRunner:
    ...
    def _create_technical_alert(
        ...
        *,
        ...
        message = f"【{strategy_id.upper()} 预警】{symbol} {interval} {label}，收盘价 {close_price:.4f}"
